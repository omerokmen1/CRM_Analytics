...
# 4. Omnichannel müşterilerin hem online hem de offline platformlardan alışveriş yaptığını ifade etmektedir.
...
df.info()   # İnceleme sonucunda tarih belirten ancak object olarak kabul edilen değişkenler belirlendi.
...
bgf.fit(cltv_df['frequency'],               # nesnesi ile frequency, recency_cltv_weekly ve T_weekly değerlerini fit
        cltv_df['recency_cltv_weekly'], # metodunu kullanarak veri setine uygun hale getiriyoruz.
        cltv_df['T_weekly'])
...
cltv_df.sort_values("cltv", ascending=False)[0:20]
